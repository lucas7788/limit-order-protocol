...
async function main () {
    ...
    this.swap = await ethers.getContractAt('LimitOrderProtocol', '0x16A3de85E22EAa96C2F483c8824586cd60d64d57');
    ...
    if (true) {
        await this.swap.updateOperator("0xA00C02e940FBAb84F38d1a434Ab7D0903B869334");

        await this.link.approve(this.swap.address, '1000000');
        await this.busd.approve(this.swap.address, '1000000');
        const order = await buildOrder(this.swap, this.link, this.busd, 2, 1);
